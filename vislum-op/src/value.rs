...
pub type SValueTypeInfo = &'static ValueTypeInfo;
...
pub trait DynValue: Debug {
    ...
    /// Get the type info for the value
    fn type_info(&self) -> &'static ValueTypeInfo;
}
...
// pub struct ValueTypeVariantInfo {
//     pub name: &'static str,
//     pub constructor: fn() -> CustomValue,
// }

// impl ValueTypeVariantInfo {
//     #[inline(always)]
...
// impl Debug for ValueTypeVariantInfo {
//     fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
//         f.debug_struct("ValueTypeVariantInfo")
...
//     pub serialize: fn(TaggedValue) -> Result<serde_json::Value, IncompatibleValueTypeError>,
//     pub deserialize: fn(serde_json::Value) -> Result<TaggedValue, IncompatibleValueTypeError>,
// }
...
pub struct ValueTypeInfo {
    ...
    // pub variants: Option<&'static [ValueTypeVariantInfo]>,
...
impl std::fmt::Debug for ValueTypeInfo {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
...
macro_rules! impl_value {
    ($($name:ident($type:ty)),* $(,)?) => {
        ...
        $(
            impl Value for $type {
                const INFO: ValueTypeInfo = ValueTypeInfo {
